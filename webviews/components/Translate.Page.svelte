...
import SvelteTable from "./SvelteTable.svelte";
    ...
    const rows = [
		...
		{ id: 22, first_name: "Martin Luther", last_name: "King", gender: "male" },
		{ id: 23, first_name: "Nelson", last_name: "Mandela", gender: "male" },
		{ id: 24, first_name: "Winston", last_name: "Churchill", gender: "male" },
		...
		{ id: 29, first_name: "Margaret", last_name: "Thatcher", gender: "female" },
		{ id: 30, first_name: "Christopher", last_name: "Columbus", gender: "male" },
		...
		{ id: 35, first_name: "Queen", last_name: "Victoria", gender: "female" },
		{ id: 36, first_name: "Pope", last_name: "Francis", gender: "male" },
		{ id: 37, first_name: "Paul", last_name: "McCartney", gender: "male" },
		{ id: 38, first_name: "Queen", last_name: "Victoria", gender: "female" },
		...
		{ id: 42, first_name: "Martin Luther", last_name: "King", gender: "male" },
		{ id: 43, first_name: "Nelson", last_name: "Mandela", gender: "male" },
		{ id: 44, first_name: "Winston", last_name: "Churchill", gender: "male" },
		...
		{ id: 49, first_name: "Margaret", last_name: "Thatcher", gender: "female" },
		{ id: 40, first_name: "Christopher", last_name: "Columbus", gender: "male" },
		...
		{ id: 55, first_name: "Queen", last_name: "Victoria", gender: "female" },
	...
	const columns = [
		...
		},
		{
			...
			sortable: true,
			searchValue : (v) => {return v.first_name},
...
<!-- <table>
    {#each testing as row}
        <tr>
            {#each row as element}
                <td contenteditable="true" >{element}</td>
            {/each}
        </tr>
    {/each}
</table> -->
